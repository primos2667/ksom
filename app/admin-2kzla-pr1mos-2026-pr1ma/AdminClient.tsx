  ...
  return (
    <div className="min-h-screen bg-[#fbfaf8] p-5 pb-28">
      <div className="flex justify-between items-center">
        <h1 className="text-xl font-bold">Admin - Delete Bad Products</h1>
        <a href="/" className="text-xs px-4 py-2 rounded-full bg-black text-white">Home</a>
      </div>
      <p className="text-xs opacity-60 mt-2">Logged as {adminEmail} - Secure Admin ✅</p>
      <div className="mt-6 grid gap-3">
        {products.map((p: any) => (
          <div key={p.id} className="p-3 rounded-[18px] bg-white border border-black/10 flex gap-3">
            ...
            <div className="flex-1">
              ...
              <p className="text-[12px] font-bold mt-1">{p.price}</p>
              <p className="text-[10px] opacity-50">{p.location} - {p.whatsapp}</p>
